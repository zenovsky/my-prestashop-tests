...
class MainPage(BasePage):
    ...
    @log_action
    @allure_step("Open the Prestashop home page")
    def open_main(self):
        self.open("")
    ...
    @allure_attach_on_fail
    @log_action
    @allure_step("Check the main page title")
    def check_title_main(self):
        self.wait_title(self.TITLE)

    @allure_attach_on_fail
    @log_action
    @allure_step("Check for the presence of header elements")
    ...
    @allure_attach_on_fail
    @log_action
    @allure_step("Check for the presence of directory blocks")
    ...
    @allure_attach_on_fail
    @log_action
    @allure_step("Check for key blocks")
    ...
    @allure_attach_on_fail
    @log_action
    @allure_step("Check for footer elements")
    ...
    @allure_attach_on_fail
    @log_action
    @allure_step("Click the user information button")
