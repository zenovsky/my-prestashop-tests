...
class ProductCardPage(BasePage):
    ...
    @allure_attach_on_fail
    @log_action
    @allure_step("Check the title of the product card page")
    def check_title_product_card(self):
        self.wait_title(self.TITLE)

    @allure_attach_on_fail
    @log_action
    @allure_step("Check the availability of product images")
    def check_product_card_image(self):
        self.wait_element(self.PRODUCT_IMAGE)

    @allure_attach_on_fail
    @log_action
    @allure_step("Check the main elements of the product card page")
