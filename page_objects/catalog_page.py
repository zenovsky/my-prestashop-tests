...
class CatalogPage(BasePage):
    ...
    @log_action
    @allure_step("Open the catalog page")
    ...
    @allure_attach_on_fail
    @log_action
    @allure_step("Check the title of the catalog page")
    ...
    @log_action
    @allure_step("Check for a choice of catalog categories")
    ...
    @allure_attach_on_fail
    @log_action
    @allure_step("Check for a filter by supplier")
    def check_filters_suppliers(self):
        self.wait_element(self.FILTER_SUPPLIERS)

    @allure_attach_on_fail
    @log_action
    @allure_step("Check availability of supplier selection")
    ...
    @allure_attach_on_fail
    @log_action
    @allure_step("Check for brand filters")
    def check_filters_brands(self):
        self.wait_element(self.FILTER_BRANDS)

    @allure_attach_on_fail
    @log_action
    @allure_step("Check availability of brand selection")
