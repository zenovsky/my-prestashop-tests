...
class CartFactory:
    def __init__(self, carts_api, customer_factory, address_factory, product_factory):
        self.api = carts_api
    ...
    def create(self, customer_id=None, address_id=None):
        ...
        xml = CartBuilder.create(address_id=address_id, customer_id=customer_id, product_id=product_id)
        cart_id = self.api.create(xml)
        self._ids.append(cart_id)
        return {"cart_id": cart_id, "address_id": address_id, "customer_id": customer_id, "product_id": product_id}
    ...
    @log_action
    def update(self, cart_id, address_id, customer_id, product_id, new_quantity):
